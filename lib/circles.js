function circles_graph(filter) {
    ...
    var tip = d3.tip()
        ...
        .html(function (d) {
            ...
            return "<strong><span>Region/University:</strong></span><span style='color:lightskyblue'>" + region + "</span><br/>" +
            ...
            if(d.depth<2)
            {
                ...
                switch (filter) {
                    case "Starting Median Salary":
                        ...
                        $("#link_bar").hide();
                        $("#link_circle").show();
                        startCareerCollege(d.data.name);
                        break;
                    ...
                    case "Mid-Career 10th Percentile Salary":
                        ...
                        $("#link_bar").hide();
                        $("#link_circle").show();
                        midCareerTHCollege("Mid-Career 10th Percentile Salary",d.data.name);
                        break;
                    case "Mid-Career 25th Percentile Salary":
                        ...
                        $("#link_bar").hide();
                        $("#link_circle").show();
                        midCareerTHCollege("Mid-Career 25th Percentile Salary", d.data.name);
                        break;
                    case "Mid-Career 75th Percentile Salary":
                        ...
                        $("#link_bar").hide();
                        $("#link_circle").show();
                        midCareerTHCollege("Mid-Career 75th Percentile Salary", d.data.name);
                        break;
                    case "Mid-Career 90th Percentile Salary":
                        ...
                        $("#link_bar").hide();
                        $("#link_circle").show();
                        midCareerTHCollege("Mid-Career 90th Percentile Salary", d.data.name);
                        break;
                    default:
                        break;
                }
